                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <?php if(is_array($positions)): $i = 0; $__LIST__ = $positions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><span  attr-status="<?php if($position['status'] == 1): ?>-1<?php else: ?>1<?php endif; ?>"  attr-id="<?php echo ($position["id"]); ?>" class="sing_cursor singcms-on-off" id="singcms-on-off" ><?php echo (status($position["status"])); ?></span></td>
                                <td>
